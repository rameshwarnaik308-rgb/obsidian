  ...
  return (
    <div style={{padding:40}}>
      ...
      <div style={{background:'#111',border:'1px solid #1a1a1a',borderRadius:16,padding:48,textAlign:'center'}}>
        {!isPro && <div><div style={{fontSize:32,color:'#e83a2e',marginBottom:16}}>✦</div><div style={{fontSize:18,fontWeight:700,marginBottom:8}}>Pro Feature</div><p style={{color:'#666',marginBottom:24}}>Upgrade to Pro for $25/month.</p><a href="/upgrade" style={{background:'#e83a2e',color:'white',padding:'11px 28px',borderRadius:8,textDecoration:'none',fontWeight:700}}>Upgrade to Pro</a></div>}
        {isPro && <p style={{color:'#888'}}>AI coach active.</p>}
      </div>
    </div>
  )
}
